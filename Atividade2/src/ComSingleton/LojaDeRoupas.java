...
public class LojaDeRoupas {
	...
	public static LojaDeRoupas instancia;

	private LojaDeRoupas() {

	}

	public static LojaDeRoupas getInstancia() {
		if (instancia == null)
			instancia = new LojaDeRoupas();
		return instancia;
	}
